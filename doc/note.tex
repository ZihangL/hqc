...
\section{PBC Hartree Fock}
    ...
    \subsection{Integtals}
        ...
        \subsubsection{Hartree and Exchange}
            ...
            \begin{equation}
                K_{\mu p,\nu q}(\textbf{k}) = \frac{1}{N_k}\sum_{\textbf{k}'}\sum_{\lambda\sigma}P_{\lambda r,\sigma s}(\textbf{k}')\int d\textbf{r}\ \phi_{\textbf{k},p}^*(\textbf{r}-\textbf{R}_{\mu})v_{\mu p\textbf{k},\sigma s\textbf{k}'}^X(\textbf{r})\phi_{\textbf{k}',r}(\textbf{r}-\textbf{R}_{\lambda})
            \end{equation}
            in terms of exchange potential
            \begin{align}
                v_{\mu p\textbf{k},\sigma s\textbf{k}'}^X(\textbf{r}) 
