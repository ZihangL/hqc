...
\section{PBC Hartree Fock}
    ...
    \subsection{Integtals}
        ...
        \subsubsection{Range Separation}
            ...
            Range separation is a method to get the long-range and short-range part of Coulomb repulsion separately.
            ...
            \end{align}
            the Coulomb potential could be devided into two part
            \begin{align}
            ...
            We can also use this trick on getting ERIs.
