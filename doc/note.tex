...
\section{PBC Hartree Fock}
    ...
    $i,j,k,l$ to specify coeffcients of each atomic orbital,
    ...
    \subsection{Integtals}
        ...
        \subsubsection{Hartree}
            The \textbf{Hartree} term matrix element is given by
            \begin{equation}
            ...
            \end{equation}
            electron density $\rho(\textbf{r})$ for closed-shell system is given by
            \begin{equation}
                \rho(\textbf{r}) = 2\sum_{occ}\left|\psi_{\textbf{k},m}(\textbf{r})\right|^2
            \end{equation}
            Hartree potential
            \begin{equation}
